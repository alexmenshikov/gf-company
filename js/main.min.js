...
console.log(agree.querySelector(".hidden-checkbox").checked);if(!agree.querySelector(".hidden-checkbox").checked){agree.querySelector(".checkbox").classList.add("error");}});};const modalCallBack=()=>{const btn=document.querySelector(".header__phone-backcall");const modal=document.querySelector(".modal");const body=document.querySelector("body");const close=document.querySelector(".modal__close");btn.addEventListener("click",()=>{modal.classList.add("active");body.classList.add("block");validationForm();});close.addEventListener("click",()=>{modal.classList.remove("active");body.classList.remove("block");});};modalCallBack();